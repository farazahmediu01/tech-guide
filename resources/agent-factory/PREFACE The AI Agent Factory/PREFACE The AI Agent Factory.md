...
*The comprehensive deep-dive. Covers the Agent Factory thesis, the Agent Triangle (General Agents, Custom-Built AI Employees, Pre-Built AI Employees), the Build vs. Buy decision framework, Code as Universal Interface, MCP and Agent Skills, monetization models, case studies, security, and the complete roadmap from first spec to first dollar.*
...
*The updated classification framework. Covers the three paths to agentic AI automation — General Agents (consultants), Custom-Built AI Employees (build), and Pre-Built AI Employees (buy) — with OpenClaw deep-dive, decision framework, and the Digital FTE spectrum.*
...
$200/mo per human user

90% reduction in software overhead

**Speed**

Days of human processing

Tasks that took humans days now take agents seconds

**Integration**

Humans log in to separate tools

Agents inhabit the workflow—no UI, no third-party login

**Scaling**

Linear: hire more humans, buy more seats

Exponential: clone the agent instantly
...
`def process_invoice(data):` `validate_schema(data)` `extract_fields(data)` `match_po_number(data)` `calculate_totals(data)`

"Create an agent that processes invoices. It should validate the data, extract key fields, match with PO numbers, and generate a summary report."

**Learning**

Months of learning. Years to master.

Minutes to describe. Instant to build.

**Tool**

IDE + compiler + documentation

Claude Code — describe what you want in plain English
...
Operations and inventory automation

**Healthcare Pros**

Scheduling and documentation agents
...
Grading and curriculum planning

**Accountants**

Transaction reconciliation and audit agents
...
Lives in Specs and Skills

**Automation**

Brittle, task-level scripts

Goal-driven agent workflows

**Knowledge**

Undocumented, unscalable
...
Humans → Digital FTEs → Agent Skills + MCP → Data
...
Director who specifies intent

**Best For**

Novel problems, unclear requirements, building Custom Agents
...
Operates across system-level tools

**Built For**

Developers

Anyone solving problems

**Example Tasks**

"Implement feature, refactor module"

"Plan your 2026", "Draft emails", "Why did sales drop?"
...
Builder who creates the agent

**Best For**

Well-defined workflows, customer-facing products, high-volume automation
...
Claude Code, Cowork, Codex, Goose
...
OpenAI Agents Framework, Google ADK, Claude Agent Framework
...
OpenClaw, Manus, Devin, Harvey

Configure & onboard

Pre-Trained New Hire (BUY)
...
A: General Agent (Claude Code, Goose)

B: Custom-Built (OpenAI Agents Framework, Google ADK)

C: Pre-Built (OpenClaw, Manus, Devin)
...
Anyone (multi-channel)

**Error Tolerance**

High (human in the loop)

Low (must be reliable)

Medium (self-correcting)

**Cost Sensitivity**

Low (high value per task)

High (volume optimization needed)

Medium (subscription-based)

**Implementation**

Instant (install and run)

Weeks (design and build)

Days (configure and onboard)

**Workforce Analogy**

Contractor

Custom-trained new hire

Pre-trained new hire
...
High (when properly evaluated)

**Scaling**

Linear (hire 10 for 10x)

Exponential (instant clone)
...
$500 (Digital FTE subscription)

**ROI (90 Days)**

Negative (ramping/training)

300% (instant deployment)
...
Monthly fee for a fully managed Digital FTE ($500-2,000/mo)

Clients who want "hands-off" automation

**2\. Success Fee**

Commission on results ($5 per lead, 2% of savings)

High-trust relationships with aligned incentives

**3\. License**

Annual fee to use your proprietary agent logic

Enterprises needing data in-house (healthcare, finance, defense)

**4\. Marketplace**

Sell via OpenAI Apps to millions of users

Volume play, brand building around niche expertise
...
The right to rebrand your Agent Skill as their own

High upfront + royalty

**Enterprise Site License**

Unlimited use of a Skill and Agents across an organization

Annual Recurring Revenue

**Developer License**

The right to use your Skill as a sub-module in their agents

Usage-based or flat tier
...
AI agents execute specs, not vague ideas. Unclear requirements = endless iterations.

**AI Collaboration**

You must teach AI your domain expertise through the Teacher/Student/Co-Worker dynamic—encoding it into `SKILL.md` files that become portable, monetizable assets.

**MCP Integration**

Model Context Protocol—the universal standard for connecting agents to real business data (CRM, databases, APIs).

**Testing & Evaluation**

Enterprises need accuracy guarantees—a "Golden Dataset" of 50+ real-world scenarios your agent must pass with 97%+ accuracy before deployment.

**Cloud Deployment**

Scale to thousands of customers without hiring operations teams.

**Build vs. Buy Evaluation**

Know when to architect a custom agent and when to onboard a pre-built one. The wrong choice wastes months or money.
...
Spec writing, AI collaboration, MCP, testing

Your first working agent

**Products** (Parts 6-9)

Agent Frameworks, multi-agent orchestration, build vs. buy

Custom or Pre-Built Agents for real workflows

**Revenue** (Parts 10-13)

Deployment, operations, marketplace

Sellable Digital FTEs
...
~$1 trillion erased from software stocks after Anthropic's eleven Claude Cowork plugins launched.
...
## PREFACE: The AI Agent Factory Assessment

Question 1 of 30

### According to the preface, what percentage of AI agent failures stem from organizational issues rather than technical ones?
