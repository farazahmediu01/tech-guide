...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Deploying-Agent-Factories-in-the-Cloud/dapr-actors-workflows/multi-app-workflows>  
...
**Pros:** Clear ownership, simple debugging **Cons:** Orchestrator becomes bottleneck
...
**Pros:** Team autonomy, independent deployments **Cons:** Distributed debugging is harder
...
**Pros:** Single entry point, request correlation **Cons:** Gateway complexity
