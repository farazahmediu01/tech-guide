...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/custom-mcp-servers/packaging-distribution>  
...
**Why this structure?**
  ...
  3. **if**name** == "**main** "**: Allows testing by running the module directly: `python -m my_mcp_server`
