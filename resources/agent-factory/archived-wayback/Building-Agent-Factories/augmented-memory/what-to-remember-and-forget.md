...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/augmented-memory/what-to-remember-and-forget>  
...
Problem| Impact| **Storage costs**|  Memory grows unbounded. Vector databases cost money.| **Retrieval noise**|  Too many memories = wrong memories retrieved.| **Contradiction chaos**|  Old information conflicts with new information.  
---|---  
...
**1\. Semantic Similarity** How closely does this memory match the current query?
...
**2\. Recency** How recently was this memory created or accessed?
...
**3\. Access Frequency** How often is this memory retrieved?
...
Agent Type| Semantic (w1)| Recency (w2)| Frequency (w3)| Customer Support| 0.6| 0.3| 0.1| Personal Assistant| 0.4| 0.4| 0.2| Research Agent| 0.7| 0.1| 0.2| Task Manager| 0.5| 0.3| 0.2  
---|---|---|---  
...
**2\. Privacy Compliance (GDPR Article 17)** The "right to be forgotten" requires complete deletion upon user request:
...
**3\. Outdated Information** When new information supersedes old:
...
**4\. Time-based Expiration** Some memories should auto-expire:
...
Requirement| Implementation| User deletion request| Delete all user memories immediately| Consent withdrawal| Delete memories created after consent given| Purpose limitation| Only store memories for stated purpose| Data minimization| Don't store more than necessary| Accuracy| Correct or delete inaccurate memories| Audit trail| Log all deletions with timestamps  
---|---  
