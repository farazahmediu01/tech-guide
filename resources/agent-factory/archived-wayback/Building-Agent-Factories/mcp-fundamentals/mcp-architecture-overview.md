...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/mcp-fundamentals/mcp-architecture-overview>  
...
AI Applications| External Systems| Custom Integrations Needed| 3 applications| 5 systems| 3 × 5 = **15 integrations**|  5 applications| 10 systems| 5 × 10 = **50 integrations**|  10 applications| 20 systems| 10 × 20 = **200 integrations**  
---|---|---  
...
AI Applications| MCP Servers| Total Components| 3 applications| 5 servers| 3 + 5 = **8 components**|  5 applications| 10 servers| 5 + 10 = **15 components**|  10 applications| 20 servers| 10 + 20 = **30 components**  
---|---|---  
...
SDK| Schema Key for Parameters| OpenAI| `function.parameters`| Anthropic| `input_schema`| Google ADK| `input`  
---|---  
