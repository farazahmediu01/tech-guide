...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/introduction-to-ai-agents/agent-ops>  
...
**Why this works:**
  ...
  * Can explain _why_ a response scored low
...
**Example:** Claude Code fails to fix a bug. Instead of just trying again, analyze:
