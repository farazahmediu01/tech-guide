...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/introduction-to-ai-agents/your-first-agent-concept>  
...
Traditional software specs describe _what code does_ : "Read file, parse JSON, validate schema, return result."

Agent specs describe _how the agent thinks and behaves_ : "You are a customer support agent. Your goal is to resolve inquiries with empathy. You can issue refunds up to $500. Escalate anything larger."
