...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/chatkit-server/connecting-your-first-agent>  
...
**Testing:** Open browser at `http://localhost:8000` → ChatKit's built-in UI loads → Start conversing with your agent.
