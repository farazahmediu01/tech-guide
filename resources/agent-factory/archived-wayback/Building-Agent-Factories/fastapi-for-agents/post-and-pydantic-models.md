...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/fastapi-for-agents/post-and-pydantic-models>  
...
This matters for agents: when clients send requests to your agent endpoints (Lesson 7), Pydantic ensures the input is valid _before_ your agent sees it. Bad data gets rejected at the door, not halfway through an expensive LLM call.
