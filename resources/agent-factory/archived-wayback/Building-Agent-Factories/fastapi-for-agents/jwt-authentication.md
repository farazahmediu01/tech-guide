...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/fastapi-for-agents/jwt-authentication>  
...
**Key insight:** JWTs are _signed_ , not encrypted. Anyone can read the payload. But only your server can create valid signatures.
