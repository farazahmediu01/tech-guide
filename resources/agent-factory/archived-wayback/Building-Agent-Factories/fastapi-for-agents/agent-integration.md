...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/fastapi-for-agents/agent-integration>  
...
Endpoint| Operation| `POST /tasks`| Create task| `GET /tasks`| List tasks| `GET /tasks/{id}`| Get task| `PUT /tasks/{id}`| Update task| `DELETE /tasks/{id}`| Delete task  
---|---  
