...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/openai-agents-sdk/agents-as-tools-orchestration>  
...
Using the Orchestrator Pattern section as reference:
...
Use the `.as_tool()` method you learned in Converting Agents to Tools:
