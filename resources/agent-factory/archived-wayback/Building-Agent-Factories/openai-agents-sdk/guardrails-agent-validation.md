...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/openai-agents-sdk/guardrails-agent-validation>  
...
Using the @input_guardrail decorator section as reference:
...
Using the @output_guardrail decorator section as reference, prevent agents from leaking:
...
Try adding an **agent-based guardrail** that uses another agent for nuanced content moderation (see Agent-Based Guardrails section).
