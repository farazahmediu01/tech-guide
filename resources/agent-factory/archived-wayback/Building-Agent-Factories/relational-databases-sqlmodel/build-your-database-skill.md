...
> **Archived from:** <https://agentfactory.panaversity.org/docs/Building-Agent-Factories/relational-databases-sqlmodel/build-your-database-skill>  
...
Lesson| You Learn| Your Skill Improves| L01| Why agents need structured data| Understands relational vs vector DB| L02| Async engine setup| Generates correct engine config| L03| Model design| Handles JSONB and constraints| L04| Session management| Knows AsyncSession lifecycle| L05| CRUD operations| Generates proper async CRUD| L06| Relationships| Includes selectinload patterns| L07| Transactions| Handles rollback correctly| L08| Migrations| Knows Alembic async setup| L09| Complete layer| Generates full database layer  
---|---|---  
